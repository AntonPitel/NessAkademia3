...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        SubscribersAdress johnCarrotAddress = new SubscribersAdress("Hlavna", 17, "Kosice", "Slovakia", 4001);
        Subscriber johnCarrot = new Subscriber("John", "Carrot", johnCarrotAddress, "john.carrot@gmail.com", 25);

        Borrowingbook borrowing1 = new Borrowingbook(physics, johnCarrot, LocalDate.now());
